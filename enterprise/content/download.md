  ...
  branches:
    - branch: "7.12"
      releases:
        ...
        - number: "7.12.0-alpha3"
          note: "https://blog.camunda.com/post/2019/08/camunda-bpm-7120-alpha3-released"
          date: "2019.08.30"
          excludeservers:
            - "wildfly11"
            - "wildfly10"
        ...
        - number: "7.12.0-alpha2"
          note: "https://blog.camunda.com/post/2019/08/camunda-bpm-7120-alpha2-released"
          date: "2019.08.02"
          excludeservers:
            - "wildfly11"
            - "wildfly10"
        ...
        - number: "7.12.0-alpha1"
          note: "https://blog.camunda.com/post/2019/06/camunda-bpm-7120-alpha1-released/"
          date: "2019.06.28"
          excludeservers:
            - "wildfly11"
            - "wildfly10"
    ...
    - branch: "7.10"
      releases:
        - number: "7.10.11"
          note: "https://app.camunda.com/jira/secure/ReleaseNote.jspa?projectId=10230&version=15529"
          date: "2019.10.29"
          excludeservers:
            - "wildfly11"
            - "wildfly10"
        ...
        - number: "7.10.10"
          note: "https://app.camunda.com/jira/secure/ReleaseNote.jspa?projectId=10230&version=15518"
          date: "2019.09.26"
          excludeservers:
            - "wildfly11"
            - "wildfly10"
    ...
    - branch: "7.9"
      releases:
        - number: "7.9.17"
          note: "https://app.camunda.com/jira/secure/ReleaseNote.jspa?projectId=10230&version=15530"
          date: "2019.10.29"
          excludeservers:
            - "wildfly"
            - "glassfish"
        ...
        - number: "7.9.16"
          note: "https://app.camunda.com/jira/secure/ReleaseNote.jspa?projectId=10230&version=15519"
          date: "2019.08.28"
          excludeservers:
            - "wildfly"
            - "glassfish"
...
<table class="table">
  ...
  <tbody>
      ...
      <td>01.11.2019</td>
      <td>
        <a class="btn btn-sm btn-default optimize-download" href="https://camunda.org/enterprise-release/optimize/2.7.0-alpha1/camunda-optimize-2.7.0-alpha1-demo.zip">zip</a>&nbsp;
        <a class="btn btn-sm btn-default optimize-download" href="https://camunda.org/enterprise-release/optimize/2.7.0-alpha1/camunda-optimize-2.7.0-alpha1-demo.tar.gz">tar.gz</a>
      </td>
    </tr>
    <tr class="well">
      <td><a href="/optimize">Camunda Optimize</a></td>
...
<table class="table">
  ...
  <tbody>
      ...
      <td>01.11.2019</td>
      <td>
        <a class="btn btn-sm btn-default optimize-download" href="https://camunda.org/enterprise-release/optimize/2.7.0-alpha1/camunda-optimize-2.7.0-alpha1-production.zip">zip</a>&nbsp;
        <a class="btn btn-sm btn-default optimize-download" href="https://camunda.org/enterprise-release/optimize/2.7.0-alpha1/camunda-optimize-2.7.0-alpha1-production.tar.gz">tar.gz</a>
      </td>
    </tr>
    <tr class="well">
      <td><a href="/optimize">Camunda Optimize</a></td>
